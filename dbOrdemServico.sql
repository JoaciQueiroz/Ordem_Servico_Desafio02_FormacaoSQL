...
CREATE TABLE `tblcliente` (
  ...
  UNIQUE KEY `cpf_cnpj_UNIQUE` (`cpf`),
  KEY `fk_tblCliente_tblPessoa1_idx` (`idPessoa`),
  CONSTRAINT `fk_tblCliente_tblPessoa1` FOREIGN KEY (`idPessoa`) REFERENCES `tblpessoa` (`idPessoa`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tblcontato` (
  ...
  `Ceclular` varchar(12) NOT NULL,
  `whastApp` varchar(12) NOT NULL,
  `email` varchar(100) NOT NULL,
  `idPessoa` int NOT NULL,
  PRIMARY KEY (`idContato`),
  KEY `fk_tblContato_tblPessoa1_idx` (`idPessoa`),
  CONSTRAINT `fk_tblContato_tblPessoa1` FOREIGN KEY (`idPessoa`) REFERENCES `tblpessoa` (`idPessoa`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tblfornecedor` (
  ...
  `dataAbertuda` date NOT NULL,
  `idPessoa` int NOT NULL,
  PRIMARY KEY (`idFornecedor`),
  KEY `fk_tblFornecedor_tblPessoa1_idx` (`idPessoa`),
  CONSTRAINT `fk_tblFornecedor_tblPessoa1` FOREIGN KEY (`idPessoa`) REFERENCES `tblpessoa` (`idPessoa`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tblpessoa` (
  ...
  KEY `fk_tblPessoa_tblTipoPessoa_idx` (`idTipoPessoa`),
  KEY `fk_tblPessoa_tblEndereco1_idx` (`idEndereco`),
  CONSTRAINT `fk_tblPessoa_tblEndereco1` FOREIGN KEY (`idEndereco`) REFERENCES `tblendereco` (`idEndereco`),
  CONSTRAINT `fk_tblPessoa_tblTipoPessoa` FOREIGN KEY (`idTipoPessoa`) REFERENCES `tbltipopessoa` (`idTipoPessoa`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tbltipopessoa`
--

DROP TABLE IF EXISTS `tbltipopessoa`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `tbltipopessoa`
--

LOCK TABLES `tbltipopessoa` WRITE;
/*!40000 ALTER TABLE `tbltipopessoa` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbltipopessoa` ENABLE KEYS */;
UNLOCK TABLES;
